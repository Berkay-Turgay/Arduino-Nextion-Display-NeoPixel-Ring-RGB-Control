...
Global control: Apply a color to the entire ring at once

Live preview: Changes update instantly on the NeoPixel ring

Nextion UI: RGB sliders, LED index selector, and color display

Fully compatible with WS2812 / NeoPixel LEDs
...
Color testing and calibration systems
